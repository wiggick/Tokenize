...
{
    $filename = dirname(__FILE__) . '/images/' . strtolower($key) . '.png';
    ...
    $data[] = array('value' => $key, 'text' => $item, 'html' => '<img src="images/' . strtolower($image) . '.png" alt=""/><span>' . $item . '</span>');
}
